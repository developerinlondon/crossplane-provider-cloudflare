...
type ZoneMetaInitParameters struct {
}

type ZoneMetaObservation struct {
...
type ZoneMetaParameters struct {
}
...
type ZoneObservation struct {
	...
	Meta *ZoneMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
